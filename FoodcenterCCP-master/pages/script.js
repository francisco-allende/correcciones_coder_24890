...
function impresorPrecios() {
  //Si bien ya tenes un total, usemos el del local storage para ver como es
  let totalDelStorage = localStorage.getItem("precio_carrito"); //Accedo al valor a traves de la key
